def export_data_to_json(data_list):
    ...
    try:
        ...
        folder_name = os.path.join(os.getcwd(), "hasil-scrapping-jasa")
        ...
        filename = f"hasil-scrapping-jasa-{timestamp_str}.json"
...
async def atur_jumlah_baris():
    ...
    try:
        ...
        driver.get('https://www.esdm.go.id/apdn/Jasa/')
...
def ambil_data_halaman(driver, data_list,id_counter):
    ...
    print("{:<30} {:<20} {:<20} {:<30} {:<10} {:<20} {:<20}".format("Nama Perusahaan", "Kelompok Jasa", "Bidang Jasa", "Kemampuan", "Sub Kemampuan", "Peringkat", "Nilai Keberpihakan","Status Verifikasi"))
    print("-" * 150)
    ...
    try:
        ...
        for i, row in enumerate(rows):
            try:
                ...
                kelompok = cols[1].text.strip()
                bidang_jasa = cols[2].text.strip()
                kemampuan = cols[3].text.strip()
                sub_kemampuan = cols[4].text.strip()
                peringkat = cols[5].text.strip()
                nilai_keberpihakan = cols[6].text.strip()
                status_verifikasi = cols[7].text.strip()
                ...
                print("{:<30} {:<20} {:<20} {:<30} {:<10} {:<20} {:<20}".format(nama, kelompok, bidang_jasa, kemampuan, sub_kemampuan, peringkat, nilai_keberpihakan,status_verifikasi))
                ...
                data_list.append({
                    ...
                    "Kelompok": kelompok,
                    "Bidang Jasa": bidang_jasa,
                    "Kemampuan": kemampuan,
                    "Sub Kemampuan": sub_kemampuan,
                    "Peringkat": peringkat,
                    "Nilai Keberpihakan": nilai_keberpihakan,
